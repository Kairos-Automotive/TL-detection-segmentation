...
using enet_import.py from https://github.com/kwotsin/TensorFlow-ENet/blob/master/enet.py
'''
...
class ENET:
    def __init__(self, num_classes = 0, define_graph=True, batch_size=10, image_shape=None):
        """ initialize network
        ...
        if define_graph:
            ...
            # this is different
            self._logits, self._prediction_softmax = enet_import.ENet(inputs=self._images_std,
