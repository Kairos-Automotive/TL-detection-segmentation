...
class FCN8_VGG16:
    ...
    def restore_variables(self, sess, var_values):
        ...
        for var in self._parameters:
            ...
            if name=='conv1_1/weights':
                value = value[:, :, :, 0:32]
            elif name == 'conv1_1/biases':
                value = value[0:32]
            elif name=='conv1_2/weights':
                value = value[:, :, 0:32, 0:32]
            elif name == 'conv1_2/biases':
                value = value[0:32]

            elif name=='conv2_1/weights':
                value = value[:, :, 0:32, 0:64]
            elif name == 'conv2_1/biases':
                value = value[0:64]
            elif name=='conv2_2/weights':
                value = value[:, :, 0:64, 0:64]
            elif name == 'conv2_2/biases':
                value = value[0:64]

            elif name=='conv3_1/weights':
                value = value[:, :, 0:64, 0:128]
            elif name == 'conv3_1/biases':
                value = value[0:128]
            elif name=='conv3_2/weights':
                value = value[:, :, 0:128, 0:128]
            elif name == 'conv3_2/biases':
                value = value[0:128]
            elif name=='conv3_3/weights':
                value = value[:, :, 0:128, 0:128]
            elif name == 'conv3_3/biases':
                value = value[0:128]

            elif name=='conv4_1/weights':
                value = value[:, :, 0:128, 0:256]
            elif name == 'conv4_1/biases':
                value = value[0:256]
            elif name=='conv4_2/weights':
                value = value[:, :, 0:256, 0:256]
            elif name == 'conv4_2/biases':
                value = value[0:256]
            elif name=='conv4_3/weights':
                value = value[:, :, 0:256, 0:256]
            elif name == 'conv4_3/biases':
                value = value[0:256]

            elif name=='conv5_1/weights':
                value = value[:, :, 0:256, 0:512]
            elif name == 'conv5_1/biases':
                value = value[0:512]
            elif name=='conv5_2/weights':
                value = value[:, :, 0:512, 0:512]
            elif name == 'conv5_2/biases':
                value = value[0:512]
            elif name=='conv5_3/weights':
                value = value[:, :, 0:512, 0:512]
            elif name == 'conv5_3/biases':
                value = value[0:512]

            elif name=='conv6/weights':
                ...
                value = value[4:5,4:5,0:512,0:4096]
            elif name == 'conv6/biases':
                value = value[0:4096]
            elif name=='conv7/weights':
                value = value[:, :, 0:4096, 0:1024]
            elif name == 'conv7/biases':
                value = value[0:1024]
    ...
    def _create_vgg16_conv_layers(self):
        ...
        with tf.name_scope('conv1_1') as scope:
            kernel = tf.Variable(tf.truncated_normal([3, 3, 3, 32], dtype=tf.float32, stddev=1e-1), name='weights')
    ...
    def _create_vgg16_fc_conv_layers(self):
        ...
        with tf.name_scope('conv7') as scope:
            kernel = tf.Variable(tf.truncated_normal([1, 1, 4096, 1024], dtype=tf.float32, stddev=1e-1), name='weights')
            tf.summary.histogram("weights", kernel)
    ...
    def _create_decoder(self):
        ...
        with tf.name_scope("decoder"):
            ...
            up4 = tf.layers.conv2d_transpose(conv_1x1, 256,
                                             kernel_size=4, strides=2, padding='SAME',
                                             kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3),
                                             name='up4')
            skip4 = tf.add(up4, self._pool4, name='skip4')
            up3 = tf.layers.conv2d_transpose(skip4, 128,
                                             kernel_size=4, strides=2, padding='SAME',
                                             kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3),
                                             name='up3')
            skip3 = tf.add(up3, self._pool3, name='skip3')
