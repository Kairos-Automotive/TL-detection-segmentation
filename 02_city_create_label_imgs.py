#!/usr/bin/python
#
# Based on scripts provided with Cityscapes dataset
...
# This encoding might come handy for training purposes.
#
# You can use
...
# cityscapes imports
sys.path.append( os.path.normpath( os.path.join( os.path.dirname( __file__ ) , 'helpers_city' ) ) )
