...
labels = [
    ...
    Label(  'ego vehicle'          ,  1 ,      0 , 'void'            , 0       , False        , True         , (  40,  40,  40) ),
    Label(  'rectification border' ,  2 ,      0 , 'void'            , 0       , False        , True         , (  60,  60,  60) ),
    Label(  'out of roi'           ,  3 ,      0 , 'void'            , 0       , False        , True         , (  80,  80,  80) ),
    Label(  'static'               ,  4 ,      0 , 'void'            , 0       , False        , True         , (  100,  100,  100) ),
